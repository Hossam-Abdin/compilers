...
ss:
    T_ID
    {
        std::cout << "ss -> T_ID" << std::endl;
    }
|
    T_ID T_COMMA ss
    {
        std::cout << "ss -> T_ID T_COMMA" << std::endl;
    }
;
...
|
    T_INTEGER ss T_SEMICOLON
    {
        std::cout << "declaration -> T_INTEGER ss T_SEMICOLON" << std::endl;
    }
|
    T_BOOLEAN ss T_SEMICOLON
    {
        std::cout << "declaration -> T_INTEGER ss T_SEMICOLON" << std::endl;
    }
;
