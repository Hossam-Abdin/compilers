// Generated by Bisonc++ V5.02.00 on Mon, 19 Oct 2020 19:27:24 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {295, 3}, // 6: declaration (T_INTEGER) ->  T_INTEGER ss T_SEMICOLON
     {295, 3}, // 7: declaration (T_BOOLEAN) ->  T_BOOLEAN ss T_SEMICOLON
     {294, 1}, // 8: statements ->  statement
     {294, 2}, // 9: statements ->  statement statements
     {297, 2}, // 10: statement (T_SKIP) ->  T_SKIP T_SEMICOLON
     {297, 1}, // 11: statement ->  assignment
     {297, 1}, // 12: statement ->  read
     {297, 1}, // 13: statement ->  write
     {297, 1}, // 14: statement ->  branch
     {297, 1}, // 15: statement ->  loop
     ...
     {303, 1}, // 22: expression (T_NUM) ->  T_NUM
     {303, 1}, // 23: expression (T_TRUE) ->  T_TRUE
     {303, 1}, // 24: expression (T_FALSE) ->  T_FALSE
     {303, 1}, // 25: expression (T_ID) ->  T_ID
     {303, 3}, // 26: expression (T_ADD) ->  expression T_ADD expression
     {303, 3}, // 27: expression (T_SUB) ->  expression T_SUB expression
     {303, 3}, // 28: expression (T_MUL) ->  expression T_MUL expression
     {303, 3}, // 29: expression (T_DIV) ->  expression T_DIV expression
     {303, 3}, // 30: expression (T_MOD) ->  expression T_MOD expression
     {303, 3}, // 31: expression (T_LESS) ->  expression T_LESS expression
     {303, 3}, // 32: expression (T_GR) ->  expression T_GR expression
     {303, 3}, // 33: expression (T_EQ) ->  expression T_EQ expression
     {303, 3}, // 34: expression (T_AND) ->  expression T_AND expression
     {303, 3}, // 35: expression (T_OR) ->  expression T_OR expression
     {303, 2}, // 36: expression (T_NOT) ->  T_NOT expression
     {303, 3}, // 37: expression (T_OPEN) ->  T_OPEN expression T_CLOSE
     {296, 1}, // 38: ss (T_ID) ->  T_ID
     {296, 3}, // 39: ss (T_ID) ->  T_ID T_COMMA ss
