// Generated by Bisonc++ V5.02.00 on Mon, 19 Oct 2020 18:55:44 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {297, 1}, // 4: type (T_INTEGER) ->  T_INTEGER
     {297, 1}, // 5: type (T_BOOLEAN) ->  T_BOOLEAN
     {298, 3}, // 6: ss (T_COM) ->  type T_COM ss
     {298, 1}, // 7: ss ->  type
     {296, 3}, // 8: declaration (T_ID) ->  type T_ID T_SEMICOLON
     {296, 5}, // 9: declaration (T_LESS) ->  T_LESS ss T_GR T_ID T_SEMICOLON
     {295, 1}, // 10: statements ->  statement
     {295, 2}, // 11: statements ->  statement statements
     {299, 2}, // 12: statement (T_SKIP) ->  T_SKIP T_SEMICOLON
     {299, 1}, // 13: statement ->  assignment
     {299, 1}, // 14: statement ->  read
     {299, 1}, // 15: statement ->  write
     {299, 1}, // 16: statement ->  branch
     {299, 1}, // 17: statement ->  loop
     {300, 4}, // 18: assignment (T_ID) ->  T_ID T_ASSIGN expression T_SEMICOLON
     {300, 6}, // 19: assignment (T_ID) ->  T_ID T_DOT T_NUM T_ASSIGN expression T_SEMICOLON
     {301, 5}, // 20: read (T_READ) ->  T_READ T_OPEN T_ID T_CLOSE T_SEMICOLON
     {301, 7}, // 21: read (T_READ) ->  T_READ T_OPEN T_ID T_DOT T_NUM T_CLOSE T_SEMICOLON
     ...
     {305, 3}, // 42: expression (T_ID) ->  T_ID T_DOT T_NUM
     {306, 1}, // 43: program_$ ->  program
};
