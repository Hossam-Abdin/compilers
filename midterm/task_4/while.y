...
type:
    T_INTEGER
    {
        std::cout << "types -> T_INTEGER" << std::endl;
    }
|
    T_BOOLEAN
    {
        std::cout << "types -> T_BOOLEAN" << std::endl;
    }
;
...
ss:
    type T_COM ss
    {
        std::cout << "ss -> type T_COM" << std::endl;
    }
|
    type
    {
...
|
    T_LESS ss T_GR T_ID T_SEMICOLON
    {
        std::cout << "declaration -> T_L_ARROW ss T_R_ARROW" << std::endl;
    }
;
...
|
    ...
    {
        std::cout << "assignment -> T_ID T_DOT T_NUM T_ASSIGN expression" << std::endl;
    }
;
