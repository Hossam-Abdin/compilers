...
|
    T_FUNCTION T_BOOLEAN T_ID T_OPEN T_INTEGER T_ID T_CLOSE declarations T_BEGIN statements T_RETURN T_ID T_SEMICOLON T_END T_SEMICOLON declarations
    {
...
|
    T_FUNCTION T_ID T_OPEN T_BOOLEAN T_ID T_CLOSE declarations T_BEGIN statements T_END T_SEMICOLON declarations
    {
        std::cout << "declarations -> T_FUNCTION T_BOOLEAN T_ID T_OPEN T_INTEGER T_ID T_CLOSE declarations T_BEGIN statements T_RETURN expression T_END T_SEMICOLON" << std::endl;
    }
;
...
|
    T_ID T_OPEN expression T_CLOSE
    {
        std::cout << "statements -> T_ID T_OPEN expression T_CLOSE" << std::endl;
    }
;
