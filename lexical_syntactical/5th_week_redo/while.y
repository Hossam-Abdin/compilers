...
%token T_ID
%token T_ARRAY
%token T_OPEN_CURLY_B
%token T_CLOSE_CURLY_B
%token T_OPEN_B
%token T_CLOSE_B
%token T_COMMA
...
|
    T_INTEGER T_ARRAY T_ID T_OPEN_B expression T_CLOSE_B T_SEMICOLON
    {
...
|
    T_ID T_ASSIGN T_TIME_STAMP T_SEMICOLON
    {
        std::cout << "assignment -> T_ID T_ASSIGN T_TIME_STAMP T_SEMICOLON" << std::endl;
    }
|
    T_ID T_OPEN_B T_CLOSE_B T_EQ T_OPEN_CURLY_B num_sem_2 T_CLOSE_CURLY_B T_SEMICOLON
    {
        std::cout << "assignment -> T_ID T_ASSIGN T_TIME_STAMP T_SEMICOLON" << std::endl;
    }
|
    T_ID T_OPEN_B expression T_CLOSE_B T_ASSIGN expression T_SEMICOLON
    {
...
|
    T_READ T_OPEN T_ID T_OPEN_B expression T_CLOSE_B T_CLOSE T_SEMICOLON
    {
        std::cout << "read -> T_READ T_OPEN T_ID T_CLOSE T_SEMICOLON" << std::endl;  
    }
;
...
|
    T_ID T_OPEN_B expression T_CLOSE_B
    {
